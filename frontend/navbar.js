            ...
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        <a href="/dashboard" data-key="dashboard" data-permission-min="1" class="nav-link group flex items-center px-4 py-2 rounded-lg transition-all duration-300 hover:bg-white/20">
                        ...
                        <a href="/aprovar-usuarios" data-key="aprovar-usuarios" data-permission-min="1" class="nav-link group flex items-center px-4 py-2 rounded-lg transition-all duration-300 hover:bg-white/20">
                            ...
                            <span class="font-medium text-white">Gerenciar usuários</span>
                        </a>
                    </div>
                ...
                <div class="js-mobile-menu md:hidden hidden border-t border-white/20 pt-4 pb-4">
                    <div class="flex flex-col space-y-2">
                        ...
                        <a href="/dashboard" data-key="dashboard" data-permission-min="1" class="mobile-nav-link flex items-center px-4 py-3 rounded-lg transition-all duration-300 hover:bg-white/20">
